...
{
    // TODO: Copy this handler implementation from project Katana
    public class MyCookieAuthenticationHandler : AuthenticationHandler<CookieAuthenticationOptions>
    {
        ...
        public MyCookieAuthenticationHandler(ILogger logger)
        {
            if (logger == null)
            {
